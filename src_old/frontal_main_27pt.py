...
from frontal_config_27pt import *
...
# Set dataloader
train_loader, valid_loader = frontal_dataloader_27(batch_size=BATCH_SIZE, workers=WORKERS)
...
for epoch in range(EXP["EPOCH"]):
    ...
    df.to_csv(f"{SAVE_IMAGE_PATH}/frontal_raw_data_validation.csv", index=None, header=None)
