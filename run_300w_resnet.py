...
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=2*C.BATCH_SIZE["TRAIN"], shuffle=True, num_workers=4)
valid_loader = torch.utils.data.DataLoader(valid_dataset, batch_size=2*C.BATCH_SIZE["VALID"], shuffle=False, num_workers=4)
...
for epoch in range(C.EPOCHS):
    ...
    if loss_valid < loss_min:
        loss_min = loss_valid
        torch.save(model.state_dict(), '/home/ubuntu/workspace/FLD-scratch/result/face_landmarks_resnet.pth') 
