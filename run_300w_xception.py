...
from src.models import hrnet, resnet, basenet, resnet50d, xception
...
from src.dataset.w300_dataset_1ch import *
...
for epoch in range(C.EPOCHS):
    ...
    if loss_valid < loss_min:
        loss_min = loss_valid
        torch.save(model.state_dict(), '/home/ubuntu/workspace/FLD-scratch/result/face_landmarks_xception.pth') 
